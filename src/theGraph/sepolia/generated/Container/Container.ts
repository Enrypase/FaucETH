...
export class Container extends ethereum.SmartContract {
  ...
  getUserEvents(user: Address): Array<string> {
    let result = super.call(
      "getUserEvents",
  ...
  try_getUserEvents(user: Address): ethereum.CallResult<Array<string>> {
    let result = super.tryCall(
      "getUserEvents",
      "getUserEvents(address):(string[])",
      [ethereum.Value.fromAddress(user)]
...
export class UpdateWithdrawIntervalCall extends ethereum.Call {
  get inputs(): UpdateWithdrawIntervalCall__Inputs {
    return new UpdateWithdrawIntervalCall__Inputs(this);
  }

  get outputs(): UpdateWithdrawIntervalCall__Outputs {
    return new UpdateWithdrawIntervalCall__Outputs(this);
  }
}

export class UpdateWithdrawIntervalCall__Inputs {
  _call: UpdateWithdrawIntervalCall;

  constructor(call: UpdateWithdrawIntervalCall) {
    this._call = call;
  }
...
export class UpdateWithdrawIntervalCall__Outputs {
  _call: UpdateWithdrawIntervalCall;
